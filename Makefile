...
clean :
	rm libcypher.so rodataEnc.out main.o
...
getRodata:
	objdump -j .rodata -s ./encrypt > rodataEnc.out

addPath:
	export LD_LIBRARY_PATH=.

runDocrypt:
	gcc -c -fno-pic -fno-pie -Wall -Wno-unused-result -Wno-parentheses  -Og -m32 -fcf-protection=none   main.c -o main.o
	gcc --shared -fno-pic -m32  main.o -o libcypher.so
	LD_PRELOAD=libcypher.so ./docrypt sample.cry
